...
if(isset($_POST['search'])){
	...
	//echo $ret_val;
	echo shell_exec("python ytvid.py $par");
	header("Location: ythome.php");
	return;
}
?>
...
<body>
	...
	<form method="post">
			<h4 style="text-align: center;margin-top: 6%">Write your query below. This will download all the videos in your dekstop folder.</h4>
	<div class="jkl">
