...
if(isset($_POST['search'])){
	...
	//echo $ret_val;
	echo shell_exec("python summary.py $par");
	header("Location: newsummary.php");
	return;
}
?>
...
<body>
	...
	<form method="post">
			<h4 style="text-align: center;margin-top: 6%">Write your query below. This will provide you summary of all the text on the web.</h4>
	<div class="jkl">
